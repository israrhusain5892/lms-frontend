  ...
  return (
    <div className="w-full mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="mt-4 md:w-4/5">
        ...
        <select className="mt-1 w-full p-2 border-[#D8DDE3] border shadow-sm rounded-md ralwayfont font-semibold">
      ...
      <div className="mt-4 flex justify-between items-center w-full md:w-4/5">
        ...
        <button
          ...
          className="text-[#3B76F6] font-medium text-base"
        >
          Add More
        </button>
      </div>
      ...
      {selectedModules.map((module, index) => (
        <div
          key={index}
          className="relative mt-2 w-full md:w-4/5 flex items-center gap-2"
        >
          <select
            value={module}
            onChange={(e) => {
      ...
      <div className="mt-6 flex justify-start gap-4">
        <button className="bg-[#3B76F6] text-white px-12 py-3 interfont rounded-md">
          Save
        </button>
