...
const CourseDetails = () => {
      ...
      <section>
        ...
        <ul className="space-y-2">
          {courseMaterialsData.map((material) => (
            <li key={material.id}>
  <div
    className="flex justify-between items-center px-4 py-2 bg-gray-100 rounded cursor-pointer hover:bg-gray-200"
  ...
  >
    ...
    <span>{openMaterial === material.id ? <i className="fa-solid fa-chevron-up"></i> : <i className="fa-solid fa-chevron-down"></i>}</span>
  </div>
