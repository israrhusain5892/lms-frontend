...
const HeroSection = () => {
  return (
<section
  className="hero-section mx-auto relative bg-cover bg-center text-white py-16 px-8 flex flex-row md:flex-row items-center justify-between m-20 h-[200px] md:h-[373px] rounded-lg"
