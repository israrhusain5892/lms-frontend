...
const Sidebar = () => {
  ...
  return (
      <div className={`h-100 ${isOpen ? "w-76 md:w-[350px]" : "w-20"} ${isOpen ? "p-4 bg-white fixed 2xl:relative":"bg-[#f8fafc] relative"}  shadow-lg transition-all duration-300  top-0 left-0  sm:overflow-hidden overflow-scroll z-50`}>      
