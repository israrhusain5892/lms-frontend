...
function TopTutors() {
  return (
    <div className="container my-5">
      {/* Section Title */}
      <h1 className="text-left mb-5 fw-bold fs-1">Weekly Top Live Tutors</h1>
      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 g-3 justify-content-center">
        ...
        <div className="col">
          <div className="card text-center border-1 rounded-3" style={{ borderColor: "#D9E2FF", height: "250px" }}>
            ...
            <div className="card-body pt-4">
              <h5 className="card-title fs-4">Albert Flores</h5>
        ...
        <div className="col">
          <div className="card text-center border-1 rounded-3" style={{ borderColor: "#D9E2FF", height: "250px" }}>
            ...
            />
            <div className="card-body pt-4">
              <h5 className="card-title fs-4">Darrell Steward</h5>
        ...
        <div className="col">
          <div className="card text-center border-1 rounded-3" style={{ borderColor: "#D9E2FF", height: "250px" }}>
            ...
            />
            <div className="card-body pt-4">
              <h5 className="card-title fs-4">Jane Cooper</h5>
        ...
        <div className="col">
          <div className="card text-center border-1 rounded-3" style={{ borderColor: "#D9E2FF", height: "250px" }}>
            ...
            />
            <div className="card-body pt-4">
              <h5 className="card-title fs-4">Julia Anatole</h5>
        ...
        <div className="col">
          <div className="card text-center border-1 rounded-3" style={{ borderColor: "#D9E2FF", height: "250px" }}>
            ...
            />
            <div className="card-body pt-4">
              <h5 className="card-title fs-4">Michael Roberts</h5>
