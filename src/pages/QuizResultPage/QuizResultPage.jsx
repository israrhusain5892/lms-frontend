...
const QuizResultPage = () => {
    ...
    />
            ...
            <div className='resultSection d-flex justify-content-between align-items-center'>
                ...
                <button className="bannerButton" onClick={()=>setbackpopup(true)}>Back</button>
            </div>
...

                    {
                        questions?.map((question, index) => {
                            return <div className='questionContainer d-flex align-items-start justify-content-between '>
                                    ...
                                    <div className="mt-4">
                                        {
                                            question.options?.map((option, index) => {
                                                return <><label key={index} className="options">
                                                    <input type="radio"
                                ...
                                <button className="marksButton">{question.result=='correct' ? '1/1' : '0/1'} Point</button>
                            </div>
                        })
                    }
